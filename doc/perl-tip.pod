...
Howver the most common complaint levelled against C<Fatal> is that
...
In Perl, laziness is a virtual.  Fatal allows one to write my code in
...
in your code:
    ...
    sub open_or_default {
        ...
        # in this subroutine, and no other.
...
this feature needs to be explcitly enabled:

    use autodie qw(system);     # ONLY enable autodie for system

    use autodie qw(:system);    # ONLY enable autodir for system and exec
